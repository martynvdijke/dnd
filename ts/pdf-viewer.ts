/**
 * PDF Viewer module — loads and renders PDF documents in a modal.
 */
...
export function pdfViewerDownload() {
  if (pdfViewerUrl) {
...
export function initPdfViewerCleanup() {
  ...
  document.addEventListener('keydown', function (e: KeyboardEvent) {
    ...
    if (modalEl && modalEl.classList.contains('show')) {
      if (e.key === 'ArrowLeft') { pdfViewerPrevPage(); e.preventDefault(); }
      else if (e.key === 'ArrowRight') { pdfViewerNextPage(); e.preventDefault(); }
    }
  });
}
