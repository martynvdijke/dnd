...
func HasCharacters() predicate.User {
...
func HasCharactersWith(preds ...predicate.Character) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasNpcs applies the HasEdge predicate on the "npcs" edge.
func HasNpcs() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasNpcsWith applies the HasEdge predicate on the "npcs" edge with a given conditions (other predicates).
func HasNpcsWith(preds ...predicate.NPC) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newNpcsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
// HasDiceRolls applies the HasEdge predicate on the "dice_rolls" edge.
func HasDiceRolls() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasDiceRollsWith applies the HasEdge predicate on the "dice_rolls" edge with a given conditions (other predicates).
func HasDiceRollsWith(preds ...predicate.DiceRoll) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newDiceRollsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
// HasCraftingRecipes applies the HasEdge predicate on the "crafting_recipes" edge.
func HasCraftingRecipes() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasCraftingRecipesWith applies the HasEdge predicate on the "crafting_recipes" edge with a given conditions (other predicates).
func HasCraftingRecipesWith(preds ...predicate.CraftingRecipe) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newCraftingRecipesStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasShopsWith(preds ...predicate.Shop) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newShopsStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasEncounterTemplates() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasEncounterTemplatesWith(preds ...predicate.EncounterTemplate) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
// HasCampaignMembers applies the HasEdge predicate on the "campaign_members" edge.
func HasCampaignMembers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasCampaignMembersWith applies the HasEdge predicate on the "campaign_members" edge with a given conditions (other predicates).
func HasCampaignMembersWith(preds ...predicate.CampaignMember) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := newCampaignMembersStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
...
func HasWikiPages() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasWikiPagesWith(preds ...predicate.CampaignWikiPage) predicate.User {
	return predicate.User(func(s *sql.Selector) {
...
func HasShareLinks() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasShareLinksWith(preds ...predicate.ShareLink) predicate.User {
	return predicate.User(func(s *sql.Selector) {
