...
func (_q *LocationQuery) QueryUser() *UserQuery {
...
func (_q *LocationQuery) QueryCharacterLocations() *CharacterLocationQuery {
...
func (_q *LocationQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LocationQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *LocationQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *LocationQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *LocationQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *LocationQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *LocationQuery) WithUser(opts ...func(*UserQuery)) *LocationQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *LocationQuery) WithCharacterLocations(opts ...func(*CharacterLocationQuery)) *LocationQuery {
	query := (&CharacterLocationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *LocationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Location, error) {
	...
	if query := _q.withUser; query != nil {
		if err := _q.loadUser(ctx, query, nodes, nil,
			func(n *Location, e *User) { n.Edges.User = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withCharacterLocations; query != nil {
		if err := _q.loadCharacterLocations(ctx, query, nodes,
			func(n *Location) { n.Edges.CharacterLocations = []*CharacterLocation{} },
			func(n *Location, e *CharacterLocation) {
...
func (_q *LocationQuery) loadUser(ctx context.Context, query *UserQuery, nodes []*Location, init func(*Location), assign func(*Location, *User)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Location)
	for i := range nodes {
		fk := nodes[i].UserID
...
func (_q *LocationQuery) loadChildren(ctx context.Context, query *LocationQuery, nodes []*Location, init func(*Location), assign func(*Location, *Location)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(location.FieldParentID)
	}
...
func (_q *LocationQuery) loadCharacterLocations(ctx context.Context, query *CharacterLocationQuery, nodes []*Location, init func(*Location), assign func(*Location, *CharacterLocation)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int64]*Location)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(characterlocation.FieldLocationID)
	}
	query.Where(predicate.CharacterLocation(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(location.CharacterLocationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *LocationQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUser != nil {
			_spec.Node.AddColumnOnce(location.FieldUserID)
		}
		if _q.withParent != nil {
			_spec.Node.AddColumnOnce(location.FieldParentID)
		}
	}
