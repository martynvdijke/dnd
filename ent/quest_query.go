...
func (_q *QuestQuery) QueryCharacter() *CharacterQuery {
...
func (_q *QuestQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *QuestQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *QuestQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *QuestQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *QuestQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *QuestQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *QuestQuery) WithCharacter(opts ...func(*CharacterQuery)) *QuestQuery {
	query := (&CharacterClient{config: _q.config}).Query()
...
//
//	client.Quest.Query().
//		GroupBy(quest.FieldCharacterID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *QuestQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Quest, error) {
	...
	if query := _q.withCharacter; query != nil {
		if err := _q.loadCharacter(ctx, query, nodes, nil,
			func(n *Quest, e *Character) { n.Edges.Character = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *QuestQuery) loadCharacter(ctx context.Context, query *CharacterQuery, nodes []*Quest, init func(*Quest), assign func(*Quest, *Character)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*Quest)
	for i := range nodes {
...
func (_q *QuestQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(quest.Table, quest.Columns, sqlgraph.NewFieldSpec(quest.FieldID, field.TypeInt64))
	_spec.From = _q.sql
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCharacter != nil {
			_spec.Node.AddColumnOnce(quest.FieldCharacterID)
		}
	}
